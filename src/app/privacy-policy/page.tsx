	...
	return (
		<LegalPage title="PRIVACY POLICY">
			<section>
				...
				<p>
					When you purchase service from our firm, as part of the buying and
			...
			<section>
				...
				<p>
					...
					<strong>info@athayogliving.com</strong> or mailing us at:{" "}
					<strong>
			...
			<section>
				<h2>COOKIES</h2>
				<p>
					We use cookies to maintain your session and provide core site
			...
			<section>
				...
				<p>
					...
					<strong>info@athayogliving.com</strong> or by mail at{" "}
					<strong>
						No.3293, 1st floor, 12th main, HAL 2nd stage, Indiranagar,
						Bengaluru, Karnataka - 560038
					</strong>
