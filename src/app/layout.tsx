...
export const metadata: Metadata = {
	...
	description:
		"Athayog Living is a yoga and wellness platform in Indiranagar, Bangalore offering group classes, personal training, teacher training and workshops rooted in tradition.",
	icons: {
		icon: "/icon.png",
		apple: "/icon.png",
	},
