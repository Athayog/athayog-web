...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: "https://athayogliving.com/yoga-ttc-online-certification",
	},
};
						...
						<div className={styles.priceGrid}>
							<div className={styles.tier}>
								...
								<EnquireModal
									...
									pageSource="yoga-ttc-online-certification"
								>
					...
					<Reveal>
						<div className={styles.exGrid}>
							{[
								...
								{
									h: "Personal Training",
									p: "One-on-one, goal-based, from ₹18,999.",
			...
			<script
				...
				dangerouslySetInnerHTML={{
					__html: JSON.stringify({
						...
						url: "https://athayogliving.com/yoga-ttc-online-certification",
						offers: [
							{
								"@type": "Offer",
								name: "Self-Paced",
