...
export const metadata: Metadata = {
	title: "Terms of Service | Athayog",
	description: "Athayog Terms of Service",
};

export default function MobileTermsOfService() {
	return (
		<LegalPage title="TERMS OF SERVICE">
			<section>
				...
				<p>
					...
					&ldquo;our&rdquo; refer to Athayog Living. Athayog Living offers this
					mobile application, including all information, tools and services
				...
				<p>
					...
					&ldquo;Terms&rdquo;), including those additional terms and conditions
				...
				<p>
					...
					our mobile application. By accessing or using any part of the site,
					you agree to be bound by these Terms of Service. If you do not agree
					to all the terms and conditions of this agreement, then you may not
					access the mobile application or use any services. If these Terms of
				...
				<p>
					...
					of Service by posting updates and/or changes to our mobile
					application. It is your responsibility to check this page periodically
					for changes. Your continued use of or access to the mobile application
			...
			<section>
				...
				<p>
					...
					through the mobile application. These products or services may have
			...
			<section>
				...
				<p>For more detail, please review our Returns/Refund Policy.</p>
			</section>
			...
			<section>
				...
				<p>
					Third-party links on this site may direct you to third-party mobile
				...
				<p>
					...
					made in connection with any third-party mobile applications. Please
			...
			<section>
				...
				<p>
					...
					&ldquo;comments&rdquo;), you agree that we may, at any time, without
			...
			<section>
				...
				<p>
					...
					or on any related mobile application is inaccurate at any time without
				...
				<p>
					...
					related mobile application, should be taken to indicate that all
					information in the Service or on any related mobile application has
			...
			<section>
				...
				<p>
					...
					mobile application, other mobile applications, or the Internet; (h) to
					...
					security features of the Service or any related mobile application,
					other mobile applications, or the Internet. We reserve the right to
					terminate your use of the Service or any related mobile application
			...
			<section>
				...
				<p>
					...
					by us) provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; for
				...
				<p>
					In no case shall Athayog Living our directors, officers, employees,
			...
			<section>
				...
				<p>
					You agree to indemnify, defend and hold harmless Athayog Living and
			...
			<section>
				...
				<p>
					...
					or access to our mobile application or the Service following the
