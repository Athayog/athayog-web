...
export const metadata: Metadata = {
	title: "Terms of Service | Athayog Living",
	description: "Athayog Living Terms of Service",
	alternates: { canonical: "https://athayogliving.com/terms-of-service" },
};
		...
		<LegalPage title="TERMS OF SERVICE">
			<section>
				...
				<p>
					...
					to Athayog Living. Athayog Living offers this website, including all
			...
			<section>
				...
				<p>
					...
					refresh date applied in the Service or on any related mobile
			...
			<section>
				...
				<p>
					...
					website, other mobile applications, or the Internet; (h) to collect or
